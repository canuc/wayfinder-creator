...
# Add one-time sourcing to .zshrc if not already there
grep -q '.clawdbot-init' /home/clawdbot/.zshrc 2>/dev/null || {
    echo '' >> /home/clawdbot/.zshrc
    echo '# One-time setup message' >> /home/clawdbot/.zshrc
    echo '[ -f ~/.clawdbot-init ] && source ~/.clawdbot-init' >> /home/clawdbot/.zshrc
}
